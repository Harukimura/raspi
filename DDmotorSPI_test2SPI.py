...
# Initialize SPI
spi10 = spidev.SpiDev()
spi10.open(1, 0)  # Bus 0, Device 0 (SS1)
spi10.mode = 3
#spi.no_cs = True
spi10.max_speed_hz = 2000000

spi11 = spidev.SpiDev()
spi11.open(1, 1)  # Bus 1, Device 1
spi11.mode = 3
#spi.no_cs = True
spi11.max_speed_hz = 2000000
...
def transfer_spi_data(motor,data):
    ...
    time.sleep(0.020)
    response = motor.SPIid.xfer2(data)  # xfer 12 bytes
    time.sleep(0.020)
...
def loop():
    ...
    while True:
        ...
        print(data1_receive ,data2_receive)
        print(motor1.pulse ,motor2.pulse)
